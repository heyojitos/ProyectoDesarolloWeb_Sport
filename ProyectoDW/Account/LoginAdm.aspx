<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Light.master" CodeBehind="LoginAdm.aspx.cs" Inherits="ProyectoDW.LoginAdm" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form style="width: 23rem;">
        ...
        <div class="form-outline mb-4">
            <dx:ASPxTextBox ID="tbUserNameAdm" runat="server" Password="true" Width="400px" Caption="Clave" CssClass="form-control form-control-lg">
                <CaptionSettings Position="Top" />
                <ValidationSettings ValidationGroup="LoginUserValidationGroup" ErrorTextPosition="Bottom" Display="Dynamic" ErrorDisplayMode="Text">
                    <RequiredField ErrorText="Completa este campo." IsRequired="true" />
                </ValidationSettings>
        ...
        <div class="pt-1 mb-4">
            <dx:ASPxButton ID="btnLoginAdm runat="server" Text="Ingresar" ValidationGroup="LoginUserValidationGroup" CssClass=" btn-lg" Width="200px"
                OnClick="btnLoginAdm_Click">
            </dx:ASPxButton>
        </div>
