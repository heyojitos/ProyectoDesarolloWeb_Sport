    ...
    <div class="container">
        <div class="abs-center">
            ...
            <div class="login">
                ...
                <dx:ASPxTextBox ID="txtContra" ClientInstanceName="Password" Password="true" runat="server" Width="200px" Caption="Clave:">
                    <CaptionSettings Position="Top" />
                    <ValidationSettings ValidationGroup="RegisterUserValidationGroup" Display="Dynamic" ErrorTextPosition="Bottom" ErrorDisplayMode="Text">
                        <RequiredField ErrorText="Se requiere su clave" IsRequired="true" />
                    </ValidationSettings>
                </dx:ASPxTextBox>
                <dx:ASPxTextBox ID="txtConfirmContra" Password="true" runat="server" Width="200px" Caption="Confirmar clave:">
                    <CaptionSettings Position="Top" />
                    <ValidationSettings ValidationGroup="RegisterUserValidationGroup" Display="Dynamic" ErrorTextPosition="Bottom" ErrorDisplayMode="Text">
                        <RequiredField ErrorText="Se requiere confirmar la clave" IsRequired="true" />
                    </ValidationSettings>
                    <ClientSideEvents Validation="function(s, e) {
            var originalPasswd = Password.GetText();
            var currentPasswd = s.GetText();
            e.isValid = (originalPasswd  == currentPasswd );
            e.errorText = 'La clave debe coincidir';
        }" />
                </dx:ASPxTextBox>
