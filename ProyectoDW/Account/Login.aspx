...
<form style="width: 23rem;">   
    ...
    <div class="accountHeader">
        <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Iniciar sesi�n</h3>
    </div>

    <div class="form-outline mb-4">
        <dx:ASPxTextBox ID="tbUserName" runat="server" Width="400px" Caption="Correo Electr�nico" CssClass="form-control form-control-lg">
    ...
    <div class="form-outline mb-4">
        <dx:ASPxTextBox ID="tbPassword" runat="server" Password="true" Width="400px" Caption="Contrase�a"  CssClass="form-control form-control-lg" >
            <CaptionSettings Position="Top" />
            <ValidationSettings ValidationGroup="LoginUserValidationGroup" ErrorTextPosition="Bottom" Display="Dynamic" ErrorDisplayMode="Text">
                <RequiredField ErrorText="Completa este campo." IsRequired="true" />
            </ValidationSettings>
